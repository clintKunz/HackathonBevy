...
class CreateSolicitBorrow extends Component {
    ...
    render() {
        return (
            <Wrap>
                <Header>Willing to Lend Money?</Header>
                ...
                <Form onSubmit={this.handleSubmit.bind(this)}>
                    <fieldset>
                        ...
                        <label htmlFor="pitch">
                            ...
                            <textarea type="text" id="pitch" name="pitch" placeholder="I want to support a local business that is growing."  value={this.state.pitch} onChange={(e) => this.handleChange(e)}/> 
                        </label>
                    </fieldset>
